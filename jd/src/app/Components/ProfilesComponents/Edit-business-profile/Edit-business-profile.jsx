...
export default function EditBusinessProfile({ listingId }) {
  ...
  useEffect(() => {
    if (listingId) {
      setFormData({
        // Contact Person Info
        title: listingId.contactPerson?.title || "",
        firstName: listingId.contactPerson?.firstName || "",
        lastName: listingId.contactPerson?.lastName || "",
        phone: listingId.contactPerson?.contactNumber || "",
        whatsapp: listingId.contactPerson?.whatsappNumber || "",
        email: listingId.contactPerson?.email || "",
        // Business Details
        businessname: listingId.businessDetails?.businessName || "",
        Building: listingId.businessDetails?.building || "",
        Street: listingId.businessDetails?.street || "",
        Area: listingId.businessDetails?.area || "",
        Landmark: listingId.businessDetails?.landmark || "",
        city: listingId.businessDetails?.city || "",
        state: listingId.businessDetails?.state || "",
        pincode: listingId.businessDetails?.pinCode || "",
        // Business Category & Subcategory
        businessCategory: listingId.businessCategory?.category || "",
        businessSubCategory: listingId.businessCategory?.subCategory || [],
        // Images
        images: listingId.businessCategory?.businessImages || [],
        // About & Keywords
        about: listingId.businessCategory?.about || "",
        keywords: listingId.businessCategory?.keywords || [],
        // Services & Area
        services: listingId.businessCategory?.businessService || [],
        businessArea: listingId.businessCategory?.serviceArea || [],
        // Social & Web Links
        websiteURL: listingId.upgradeListing?.website || "",
        googlemap: listingId.upgradeListing?.direction || "",
        facebook: listingId.upgradeListing?.facebook || "",
        instagram: listingId.upgradeListing?.instagram || "",
        twitter: listingId.upgradeListing?.twitter || "",
        linkedin: listingId.upgradeListing?.linkedin || "",
        // Experience (if applicable)
        experience: listingId.experience || "",
        // Others (if any default)
        image: null,
      });
    }
  }, [listingId]);
    ...
    <div className="container">
      ...
      <div className="row text-center">
        {categories.map((cat) => (
          ...
          >
            <div
              className={`edit-icon-card ${activeTab === cat.id ? "active" : ""
                }`}
            >
